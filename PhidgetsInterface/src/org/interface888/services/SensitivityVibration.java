...
public class SensitivityVibration implements DeviceController{
	int index = -1;
	HashMap<String, String> values= null;
	int changed = 1;
	InterfaceKitPhidget itk = null;
	
	public SensitivityVibration(int i, InterfaceKitPhidget interfaceph) {
		itk = interfaceph;
	...
	public String getDescription() {
		return "Change de Senstivity of the vibration sensor";
	}
