package org.precisionlight.listeners;
...
import org.precisionlight.impls.ShowPrecisionLight;
...
public class AttachListenerDevice implements AttachListener{
	...
	public void attached(AttachEvent ae) {
		try {
			...
			tempsensor.openAny();
			System.out.println("Recive Event Atached: waiting for Light Precision attachment...");
			tempsensor.waitForAttachment();
			DeviceSensing ts = new ShowPrecisionLight(tempsensor);
