...
public class SensitivityTouch implements DeviceController{
	int index = -1;
	HashMap<String, String> values= null;
	int changed = 1;
	InterfaceKitPhidget itk = null;
	
	public SensitivityTouch(int i, InterfaceKitPhidget interfaceph) {
		itk = interfaceph;
		values = new HashMap<String, String>();
		index = i;
		values.put("Data Rate", "0");//actualizado quando iniciado
		values.put("Sensitivity of Touch", "10");
	}

	@Override
	public String getDescription() {
		return "Change de Senstivity of the touch sensor";
	}

	@Override
	public String getName() {
		return "Senstivity Service of Touch Sensor";
	}
